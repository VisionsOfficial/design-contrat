...
const LS_KEY = "vt.offerSettings2.check_free_offer";
...
function TermsPanel({ section, st, set, onAdopt }) {
  const intro = section.repeatable ? null : (
    <ActionExplain icon="triggers" title={'“Negotiable” vs “Fixed” terms'}>
      Flip a term to <b>Negotiable</b> to let the contract agent settle it automatically, within the acceptance range you set — deals close without waiting on you. Terms left <b>Fixed</b> apply to every taker exactly as published.
    </ActionExplain>
  );
  if (section.repeatable) {
    return (
...
function OfferSettingsApp() {
  ...
  return (
    <div className="app ui-v2 os-app">
      ...
      <AppSidebar variant={window.NAV_VARIANT || "v2"} activeId="offers" />
      <div className="main">
          ...
          <div className="os-page">
            ...
            <div style={{ marginTop: 16 }}>
                <div className="os-settings-head">
                  ...
                  <p>Everything about this offer, grouped by topic. Pick a category on the left — every term is laid out with its value and negotiability in view.</p>
                </div>
